...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::pipeline_presets::list_pipeline_presets,
            commands::pipeline_presets::save_pipeline_preset,
            commands::pipeline_presets::update_pipeline_preset,
            commands::pipeline_presets::delete_pipeline_preset,
