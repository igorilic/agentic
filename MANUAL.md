...
| **TUI** (`agentic-tui`) | Steps 12.1–12.2 — alt-screen with two-pane (cockpit \| chat) layout, `Tab` toggles focus, `[` / `]` resize cockpit (clamped 20–80%), `q` / `Esc` quits. Event subscription and chat input are Steps 12.3–12.5. |
...
- TUI (Phase 12): scaffolding (12.1) + two-pane layout with focus + resize (12.2) shipped. Event subscription, cockpit rendering, and chat input are 12.3–12.5.
